...
\newcommand{\myProf}{Prof. (FH) Dr. Johannes L\"{u}thi\xspace}
\newcommand{\myOtherProfFirst}{Krispin Raich, MSc\xspace}
\newcommand{\myOtherProfSecond}{Prof. (FH) PD Dr. Mario D\"{o}ller\xspace}
