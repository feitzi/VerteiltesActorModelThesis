\chapter{Umsetzung eines Verteilten Transaktionalen Systems mit dem  Actor-Model} 
...
Der Actor wird in der Implementierung als \textit{Supplier} bezeichnet und besitzt selbst wieder ein Kind-Actor, welcher für die Aufbereitung der Abfragedaten, wie in Abschnitt \ref{subsubsub:implementation:queryActorModel:resultPreparator} beschrieben, zuständig ist. \\
