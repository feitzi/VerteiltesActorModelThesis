...
Abschließend lässt sich aus der Arbeit ableiten, dass das \textit{Actor-Model} geeignet ist verteilte Transaktionssysteme zu realisieren. Dabei müssen zwar etliche Komplikationen beachtet werden, was jedoch generell für Verteile Systeme gilt.
