...
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:34:54.053Z:
% 
% > Bevor es nach der Speicherung des Events die übergebene Action ausführt, wird die abstrakte Methode \textit{UpdateState()} aufgerufen.
% Was willst du damit aussagen? Verstehe den Zusammenhang zum vorherigen Satz nicht. 
% 
% ^.
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:27:48.227Z:
% 
% > Weiters wird eine Action übergeben, welche ausgeführt wird, sobald das Event erfolgreich im \textit{Event Store} abgelegt wurde. 
% Was? Bitte umändern, du hast zwei Zeitformen in einem Satz und wieder "welche" drinnen. 
% 
% Eine ausführende Aktion wird übergeben, sobald das Event erfolgreich im Store abgelegt  wurde. 
% 
% ^.
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:20:12.903Z:
% 
% > Die Basisklasse bietet die Methode \textit{Emit(IDomainEvent e, Action a)} an, welche die eigentliche Logik für die Speicherung des Events übernimmt. Der Verwender der Methode \textit{Emit()} übergibt dieser ein Event, welche alle Informationen über das aufgetretene Ereignis enthält.
% 1. was meinst du mit dieser?
% 2. Wortwiederholung "welche/r"
% 
% ^.
...
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:42:40.341Z:
% 
% >  Die Action wird nur aufgerufen, wenn das Event tatsächlich auftritt, bei einer wiedereinspielung des Events wird ausschließlich die Methode \textit{UpdateState} aufgerufen.  \\
% Das hast du doch weiter oben schon erwähnt?! 
% 
% ^.
...
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:50:36.118Z:
% 
% > serialisierbare
% serialisierte? 
% 
...
% * <feitzinger.magdalena@gmail.com> 2018-05-19T14:59:51.616Z:
% 
% > Wie bereits angedeutet, sind nicht alle Actors innerhalb der \textit{TyrolSky}-Anwendung unter \textit{Event Sourcing}. 
% Satz ist unvollständig. 
% Sind nicht alle Actors innerhalb der Anwendung unter "Event Sourcing" zu finden? 
% 
% ^.
\begin{itemize}
...
% * <feitzinger.magdalena@gmail.com> 2018-05-19T15:06:34.654Z:
% 
% > Versionierung
% gibt es dieses Wort? 
% 
