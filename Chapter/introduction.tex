...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:18:33.703Z:
% 
% vermutlich ist eine Vermutung deinerseits. Ist deine subjektive Meinung. Hat in der Einleitung nichts verloren.
% 
% ^.
...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:20:39.696Z:
% 
% statt Popularität wurde ich schreiben: 
% hat sich das Actor-Modell in der Software-Entwicklung durch versch. Projekte.. (...) wieder etablisiert.
% 
% ^.
...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:25:08.388Z:
% 
% Hast du einen einzigen Schwerpunkt bei der Rercherche gehabt? Oder mehrere?  
% 
% ^.
...
\end{Theorem}
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:31:42.257Z:
% 
% Du hast hier die Forschungsfrage ins Kapitel eingearbeitet. Ist nicht notwendig, da ja eine Zeile drunter das die Fragestellung beschrieben wird. 
% 
% ^.
\section{Methodik}
...
\section{Aufbau}
Die Arbeitet unterteilt sich in zwei Teile. Beginnend mit dem theoretische ersten Teil wird in dem Kapitel \fullref{actor:chapter} auf das \textit{Actor-Model} eingegangen und dieses diskutiert. Nachfolgend folgt das Kapitel \fullref{cha:distributedSystems} welches sich mit den häufig bei verteilten System zu findenden Problemen beschäftigt. Der theoretische Teil der Arbeit wird mit dem Kapitel \fullref{cha:transactionSystems} abgeschlossen, in welchem bekannte Lösungsansätze für transaktionale Systeme behandeln werden. \\
Der zweite Teil der Arbeit umfasst die praktische Auseinandersetzung mit der Forschungsfrage. Dabei wird in Kapitel \fullref{cha:Eruierung} der Anforderungskatalog, basierend auf den in Teil eins erarbeiteten Informationen, erstellt und vorhandene Frameworks für die Umsetzung betrachtet. Auf die Umsetzung des Anforderungskataloges wird in Kapitel \fullref{cha:practicalDevelopment} eingegangen. Abschließend wird in Kapitel \fullref{cha:evaluation} der erarbeite Erkenntnisstand diskutiert und bewertet.  