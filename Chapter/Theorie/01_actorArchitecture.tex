\section{Actor basiertes Architekturmuster}\label{sec:theory:actorArchitecture}
...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:57:31.772Z:
% 
% > Deshalb wird die Antwort wieder in die Mailbox des Empfängers zugesendet. 
% 
% Wieso wieder zugesendet?
% 
% ^.
% * <feitzinger.magdalena@gmail.com> 2018-03-05T16:54:49.215Z:
% 
% Atore oder Actor-Modell?
% 
% ^.
...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T17:33:14.652Z:
%
% >  Ablauf eines Zeitfensters oder eines der anderen vier Kriterien
%
% ^.
\end{itemize}
...
% * <feitzinger.magdalena@gmail.com> 2018-03-05T17:36:04.957Z:
% 
% > In \cite{CloudComputingPatterns2014} generalisiert dieses Problem das Nachrichten zwischen Komponenten generell keiner garantierten Zustellung unterliegen. \\
% Undeutscher Satz. 
% 
% ^.
