...
Oft verwenden \textit{Processors} auch \textit{Router} (siehe Kapitel \ref{sec:actor:patterns:routing}) und \textit{Aggregatoren} (siehe Kapitel \ref{sec:actor:patterns:aggregator}) um Ihren Prozesse in einem Actor-System abzubilden. \\
