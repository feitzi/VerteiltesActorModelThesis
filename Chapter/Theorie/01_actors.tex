...
Neben geläufigen Modellen wie beispielsweise die Funktionale Programmierung oder die Objektorientierte Programmierung bietet das Actor Model eine Vorgehensweise Software zu schreiben.   viele Vorteile welche in diesem Kapitel erarbeitet werden.  Das Kapitel teilt sich in 3 Teile auf. Zuerst wird das Actor Model in seiner Grundform wie von \cite{hewitt1973session} und \cite{Agha1985ActorsSystems} definiert gezeigt, anschließend werden Grundlegende Konzepte mit dem Actor Model durchgegangen und abschließend erfolgt eine Evaluierung des Actor Models.
