...
\begin{description}
    \item[Kein Zugriff von außen]\label{actor:requirements:shareNothing}
    ...
    \item[Asynchrone Kommunikation]\label{actor:requirements:AsynchronCommunication}
    ...
    \item[Sequentielle Abarbeitung von Nachrichten]
    ...
    \item[Frei von Sperrmechanismen]
    Durch die Bedingungen 
    \item[Kleinst mögliches Aufgabengebiet]
\end{description}
