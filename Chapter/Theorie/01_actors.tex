...
\begin{description}
    ...
    \item[Ziel Adresse] Jede Nachricht wird an einen Actor zugestellt. Deshalb enthält die Nachricht selber auch die Adresse ihres Zieles.
...
\begin{description}
    ...
    Durch die schafung eines neuen Actors ist die Adresse dem Ersteller bekannt
    Durch das Erstellen des Actors ist auch dessen Adresse dem Ersteller bekannt.
