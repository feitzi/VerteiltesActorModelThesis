...
Durch die gleichzeitige Bearbeitung von maximal einer Nachricht pro Actor sowie die Verbietung von Lesezugriffen auf den eigenen, internen State durch andere Actors (siehe \ref{??}), benötigt es keine Sperrmechanismen innerhalb eines Actors. Dadurch wird erstens der Sourcecode übersichtlicher und zweitens entfällt das aufwändige allokieren von Sperreressourcen.\citep{Vernon2015ReactiveAkka}
