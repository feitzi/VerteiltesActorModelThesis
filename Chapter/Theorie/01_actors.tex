...
Die sprachliche Unterteilung von Nachrichten in \textit{Commands}, \textit{Events}  und \textit{Documents} führt laut \cite{Evans2004Domain-drivenSoftware} zu einer besseren Verständlichkeit des Quellcodes. Technisch gesehen unterscheiden Sie sich jedoch zuerst nicht. Eine semantische Unterscheidung dieser Nachrichtenarten kann jedoch in speziellen Anwendungsgebieten Sinn ergeben. Man denke hier an beispielsweise an \textit{Event-Sourcing} (siehe \cite{betts2013CQRSEventSourcing}).
