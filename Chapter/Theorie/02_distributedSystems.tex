...
Da das verteilte System aus mehreren beteiligten Komponenten besteht, müssen diese auch miteinander kommunizieren. Da die Kommunikation in einem System nie garantiert werden kann, wie bereits in Abschnitt \ref{sec:distributedSystems:wrongAssumptions} besprochen, können durch Verbindungsunterbrechungen im Netzwerk Partitionen entstehen. Partitioniert sich ein Netzwerk, ist die Kommunikation zwischen den entstandenen Partitionen temporär nicht mehr möglich.
\end{description}
